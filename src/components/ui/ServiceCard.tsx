...
export function ServiceCard({ service }: ServiceCardProps) {
  return (
    <article className='service-card group flex h-full w-full flex-col'>
      <div className='service-card-border' aria-hidden='true' />
      <div className='relative flex h-full flex-1 flex-col gap-5 rounded-2xl bg-surface px-5 pb-5 pt-12 lg:px-5 lg:pb-6 lg:pt-16'>
        <img
          src={service.image}
          alt=''
