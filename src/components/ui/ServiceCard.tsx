...
export function ServiceCard({ service }: ServiceCardProps) {
  return (
    <article className="service-card group relative overflow-visible rounded-2xl bg-surface">
      <span className="service-card-border" aria-hidden="true" />
      <div className="relative z-[2] flex flex-col gap-5 px-5 pb-5 pt-12 lg:px-5 lg:pb-6 lg:pt-16">
        <img
          src={service.image}
          alt=""
